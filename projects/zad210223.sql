...
(ClassNum, ClassLetter, AvarageMark)
AS
SELECT ClassNum, ClassLetter, AVG(StudentMarks.Mark)
FROM Students
...
SELECT Students.ClassNum, Students.ClassLetter, Students.name, AVG(StudentMarks.Mark), AvarageMarks.AvarageMark
FROM Students
LEFT JOIN StudentMarks
ON Students.id = StudentMarks.studentId
LEFT JOIN AvarageMarks
ON AvarageMarks.ClassNum = Students.ClassNum AND AvarageMarks.ClassLetter = Students.ClassLetter
